...
create policy "Les témoins connectés lisent les mosquées" on public.mosquees
...
create policy "Les témoins connectés lisent les personnes" on public.personnes
  for select to authenticated using (true);
...
create policy "Les témoins connectés lisent les unions" on public.mariages
  for select to authenticated using (true);
